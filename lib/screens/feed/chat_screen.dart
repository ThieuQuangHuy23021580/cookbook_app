...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    _messages.add(
      Message(
        text:
            'Xin chào! Tôi là trợ lý ẩm thực của bạn. Tôi có thể giúp bạn tìm công thức nấu ăn, đưa ra gợi ý món ăn, hoặc trả lời các câu hỏi về nấu nướng. Bạn muốn hỏi gì?',
        isUser: false,
    ...
    try {
        ...
        setState(() {
          _messages.add(
            Message(
              ...
              isUser: false,
              timestamp: DateTime.now(),
              sources: response.data!.sources.isNotEmpty
      ...
      setState(() {
        _messages.add(
          Message(
            text:
                'Xin lỗi, đã xảy ra lỗi khi kết nối với AI. Vui lòng kiểm tra kết nối mạng và thử lại.',
            isUser: false,
            timestamp: DateTime.now(),
          ),
        );
