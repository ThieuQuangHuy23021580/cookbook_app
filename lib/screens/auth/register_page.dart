  ...
  Future<void> _sendOtp() async {
    if (_emailController.text.isEmpty || !_emailController.text.contains('@')) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Vui lòng nhập đúng email')));
      return;
    }
    setState(() {
      _isSendingOtp = true;
                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildErrorMessage(_nameController, (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Vui lòng nhập họ và tên';
                                }
                                if (value.length < 2) {
                              ...
                              _buildErrorMessage(_emailController, (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Vui lòng nhập email';
                                }
                                if (!value.contains('@')) {
                              ...
                              _buildErrorMessage(_passwordController, (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Vui lòng nhập mật khẩu';
                                }
                                if (value.length < 6) {
                              ...
                              _buildErrorMessage(_confirmPasswordController, (
                                value,
                              ) {
                                if (value == null || value.isEmpty) {
                                  return 'Vui lòng xác nhận mật khẩu';
                              ...
                              _buildErrorMessage(_otpController, (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Vui lòng nhập mã OTP';
                                }
                                if (value.length != 6) {
